CREATE TABLE IF NOT EXISTS `{project}.{dataset}.pipeline_runs` (
  ...
  synonym_proposals_json STRING OPTIONS(description="Mutable run-scoped synonym proposal review snapshot"),
  ...
  jobs_input_source STRING OPTIONS(description="Canonical trigger-mode source for resolved jobs input"),
  jobs_input_json STRING OPTIONS(description="Canonical resolved jobs input snapshot for the run"),
  candidate_profile_source STRING OPTIONS(description="Canonical trigger-mode source for resolved candidate profile input"),
  candidate_profile_json STRING OPTIONS(description="Canonical resolved candidate profile snapshot for the run"),
  -- lifecycle controls
